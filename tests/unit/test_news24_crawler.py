...
class TestNews24Crawler(unittest.TestCase):
    def setUp(self):
...
"""
        ...
        self.assertEqual(doc.text, u"""The wife of the man accused of abusing her and their five children and holding them captive has appeared in court, where her case was postponed for a bail application.\n\nJohannesburg - The wife of the man accused of abusing her and their five children and holding them captive appeared in the Springs Magistrate's Court on Tuesday, Beeld reported.
