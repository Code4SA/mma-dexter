...
"""
        ...
        self.assertEqual(doc.text, u"Johannesburg - Two men have been found guilty of murder,\nrape, and robbery, in the South Gauteng High Court sitting in Palm Ridge, \n\nThe Star\n\n reported on Wednesday.\n\nKyle Fredericks and Shinawaaz Ahmento, both aged 21, would\nbe sentenced on Wednesday by acting Judge Louis Vorster for murdering, raping,\nand robbing Tracey-Lee Martins.\n\nIn April last year, the two broke into Martins's home in\nKlipspruit West to rob her so they could get money for drugs, the paper\nreported.\n\nAhmento raped Martins while she was in bed, then robbed her.\nHe was a frequent visitor at the house, the paper reported. \n\nFredericks strangled Martins with socks then threw the socks\ndown a drain.\n\nMartins's son, who was aged 3 at the time, and his\n74-year-old grandmother were also at the house at the time. Ahmento strangled\nthe older woman, who survived the attack, before robbing her as well.\n\nThe two then fled the scene, the paper reported.")
